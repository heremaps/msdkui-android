...
public final class RouteDescriptionHandler {
     ...
     * @param context a context to access ressources.
    ...
    /**
     * Gets the arrival time of the associated {@link Route} with or without traffic as {@link Spannable}.
     *
     * @param isTraffic
     *         true if traffic situation should be included, false otherwise.
     * @return the {@link Spannable} containing the arrival time.
     */
