...
class MockLocationManager(private val locationManager: LocationManager) {
    ...
    /**
     * Stop mocking location providers in case started.
     */
    fun stop() {
        if (!isStarted) return
    ...
    /**
     * Restart mocking location providers and create mock location by given test place.
     * @param [TestPlace] mocking location coordinates.
     */
