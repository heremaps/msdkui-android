...
/**
 * Tests for  {@link GuidanceNextManeuverPanelPresenter}.
 */
@PrepareForTest({ NavigationManager.class })
public class GuidanceNextManeuverPanelPresenterTest extends RobolectricTest {

    private GuidanceNextManeuverPanelPresenter mNextManeuverPanelPresenter;
    private NavigationManager mNavigationManager;

    @Before
    public void setUp() {
        mNavigationManager = mock(NavigationManager.class);
        mNextManeuverPanelPresenter = new GuidanceNextManeuverPanelPresenter(getApplicationContext(), mNavigationManager,
                mock(Route.class));
    }
    ...
    public void testHandleManeuverEvent() {
        ...
        GuidanceNextManeuverPanelListener listener = mock(GuidanceNextManeuverPanelListener.class);
