...
public class HazardousMaterialsOptionsPanelTest extends RobolectricTest {
    ...
    private HazardousMaterialsOptionsPanel mDriveOptionsPanel;
    private boolean mCallbackCalled;

    @Before
    public void setUp() {
        mDriveOptionsPanel = new HazardousMaterialsOptionsPanel(getApplicationContext());
    }

    @Test
    public void testInitUiFunction() {
        final List<OptionItem> items = mDriveOptionsPanel.getOptionsSpecs();
    ...
    public void testSettingRouteOptions() {
        ...
        mDriveOptionsPanel.setRouteOptions(builder.withFullHazardousOptions()
                .build());
        final List<OptionItem> items = mDriveOptionsPanel.getOptionsSpecs();
        assertThat(items.size(), equalTo(1));
        MultipleChoiceOptionItem item = (MultipleChoiceOptionItem) items.get(0);
        ...
        mDriveOptionsPanel.setRouteOptions(builder.withFewHazardousOptions()
                .build());
        selectedIds = item.getSelectedLabels();
        assertThat(selectedIds.size(), equalTo(1));
    }
    ...
    public void testGettingRouteOptionsWhenSetFewHazardous() {
        ...
        mDriveOptionsPanel.setRouteOptions(builder.withFewHazardousOptions()
                .build());
        RouteOptions routeOptions = mDriveOptionsPanel.getRouteOptions();
    ...
    public void testChangeListener() {
        ...
        mDriveOptionsPanel.setListener(new OptionsPanel.Listener() {
            @Override
