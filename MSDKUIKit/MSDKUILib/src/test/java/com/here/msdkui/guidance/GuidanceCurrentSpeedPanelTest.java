...
/**
 * Tests for class {@link GuidanceCurrentSpeedPanel}.
 */
public class GuidanceCurrentSpeedPanelTest extends RobolectricTest {
    ...
    private GuidanceCurrentSpeedPanel mCurrentSpeedPanel = null;

    @Before
    public void setUp() {
        super.setUp();
        mCurrentSpeedPanel = new GuidanceCurrentSpeedPanel(getApplicationContext());
    }
    ...
    public void testViewDataIsParcelable() {
        final GuidanceSpeedData data = new GuidanceSpeedData(VELOCITY, SPEED_LIMIT);
        GuidanceCurrentSpeedPanel.SavedState savedState = new GuidanceCurrentSpeedPanel.SavedState(
        ...
        GuidanceCurrentSpeedPanel.SavedState createdFromParcel = GuidanceCurrentSpeedPanel.SavedState.CREATOR.createFromParcel(
                parcel);
