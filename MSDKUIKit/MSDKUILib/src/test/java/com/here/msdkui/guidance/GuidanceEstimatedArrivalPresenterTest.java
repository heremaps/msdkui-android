...
/**
 * Tests for {@link GuidanceEstimatedArrivalPresenter}.
 */
@PrepareForTest({ NavigationManager.class, RouteTta.class })
public class GuidanceEstimatedArrivalPresenterTest extends RobolectricTest {

    private GuidanceEstimatedArrivalPresenter mEstimatedArrivalPresenter;
    private NavigationManager mNavigationManager;

    @Before
    public void setUp() {
        mNavigationManager = mock(NavigationManager.class);
        mEstimatedArrivalPresenter = new GuidanceEstimatedArrivalPresenter(mNavigationManager);
    }
