...
class SubOptionPanelFragmentTest : BaseTest() {
    ...
    public override fun setUp() {
        ...
        fragment = Robolectric.buildFragment(SubOptionPanelFragment::class.java).create().resume().get()
    ...
    fun testOnUiDataReady() {
        with(fragment) {
            ...
            // checking count equal 2 because basic value is 1
            assertEquals(view.optionpanel_container.childCount, 2)
        }
    }
}