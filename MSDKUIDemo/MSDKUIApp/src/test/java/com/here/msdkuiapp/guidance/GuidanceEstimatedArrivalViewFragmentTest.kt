...
class GuidanceEstimatedArrivalViewFragmentTest :BaseTest() {
    ...
    fun testPanelCreation() {
        addFrag(guidanceEstimatedArrivalViewFragment, GuidanceEstimatedArrivalViewFragment::class.java.name)
        Assert.assertNotNull(guidanceEstimatedArrivalViewFragment)
        Assert.assertNotNull(guidanceEstimatedArrivalViewFragment.view)
    }
