This app shows how to integrate the HERE Mobile SDK and the MSDKUI (HERE Mobile SDK UI Kit) framework. If everything is set up correctly, a simple component will show the traditional "Hello World"-message.
