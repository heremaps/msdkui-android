 ...
 */
public class DriveOptionsPanelTest extends RobolectricTest {

    private RoutingOptionsPanel mRoutingOptionsPanel;
    private boolean mCallbackCalled;

    @Before
    public void setUp() {
        mRoutingOptionsPanel = new RoutingOptionsPanel(getApplicationContext());
    }

    @Test
    public void testInitUiFunction() {
        final List<OptionItem> items = mRoutingOptionsPanel.getOptionsSpecs();
    ...
    public void testSettingRouteOptions() {
        ...
        mRoutingOptionsPanel.setRouteOptions(builder.withFullDriveOptions()
                .build());
        final List<OptionItem> items = mRoutingOptionsPanel.getOptionsSpecs();
        assertThat(items.size(), equalTo(1));
        MultipleChoiceOptionItem item = (MultipleChoiceOptionItem) items.get(0);
        ...
        mRoutingOptionsPanel.setRouteOptions(builder.withFewDriveOptions()
                .build());
        selectedIds = item.getSelectedLabels();
    ...
    public void testGettingRouteOptions() {
        ...
        mRoutingOptionsPanel.setRouteOptions(builder.withFullDriveOptions()
                .build());
        RouteOptions routeOptions = mRoutingOptionsPanel.getRouteOptions();
    ...
    public void testChangeListener() {
        ...
        mRoutingOptionsPanel.setRouteOptions(options);
        mRoutingOptionsPanel.setListener(new OptionsPanel.Listener() {
            @Override
