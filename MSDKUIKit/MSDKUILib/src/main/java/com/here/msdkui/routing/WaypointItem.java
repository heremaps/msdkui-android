 ...
 */
public class WaypointItem extends RelativeLayout implements View.OnTouchListener {
    ...
    private void uiInit() {
        ...
        // drag icon handling.
        mDragIcon = (DraggableImageView) findViewById(R.id.drag_icon);
        mDragIcon.setOnTouchListener(this);
    }
    ...
    public void setWaypointEntry(final WaypointEntry entry) {
        ...
        // still same.
        view.setText(TextUtils.isEmpty(entry.getName()) ? position : entry.getName());
    }
    ...
    public interface Listener {
        ...
        /**
         * Called when the user has started to drag this item in the list.
         *
         * @param entry the {@link WaypointEntry} that is dragged.
         */
        void onDragStarted(WaypointEntry entry);
    }
}
