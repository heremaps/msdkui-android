...
import kotlinx.android.synthetic.main.route_planner.view.*
...
class RoutePlannerFragmentTest : BaseTest() {
    ...
    public override fun setUp() {
        ...
        fragment = Robolectric.buildFragment(RoutePlannerFragment::class.java).create().resume().get()
    ...
    @Test
    fun testOnRoutingFailed() {
        fragment.onRoutingFailed("abc")
        assertEquals(ShadowToast.getTextOfLatestToast(), "abc")
    }
