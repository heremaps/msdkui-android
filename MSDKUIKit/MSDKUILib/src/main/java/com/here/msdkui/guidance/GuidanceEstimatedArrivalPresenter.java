...
/**
 * This class creates {@link GuidanceEstimatedArrivalData} instances during guidance and notifies it's
 * listeners about that.
 */
public class GuidanceEstimatedArrivalPresenter extends BaseGuidancePresenter {
     ...
     */
    public GuidanceEstimatedArrivalPresenter(NavigationManager navigationManager) {
    ...
    private void updateEtaData(Date date, long distance, int duration) {
        final GuidanceEstimatedArrivalData data = new GuidanceEstimatedArrivalData(date, distance, duration);
        notifyDataChanged(data);
    }

    /**
     * Notify on {@link GuidanceEstimatedArrivalData} changes.
     */
    private void notifyDataChanged(GuidanceEstimatedArrivalData data) {
