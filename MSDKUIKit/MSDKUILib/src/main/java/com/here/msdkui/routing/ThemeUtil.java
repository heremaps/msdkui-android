...
public final class ThemeUtil {
     ...
     */
    public static Drawable getDrawable(Context context, final TypedArray a, final int attr) {
        final TypedValue value = a.peekValue(attr);
        if (value == null) {
            return null;
        }
        if (value.type == TypedValue.TYPE_REFERENCE || value.type == TypedValue.TYPE_STRING) {
            ...
            return new ColorDrawable(a.getColor(attr, 0xFF000000)); // black color
        } else {
     ...
     */
    public static String getString(final TypedArray a, final int attr) {
        final TypedValue value = a.peekValue(attr);
        if (value == null) {
            return null;
        }
