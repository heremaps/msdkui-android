 ...
 * {@link GuidanceNextManeuverPanel} to inform the user about maneuver to take after current one.
 * You must call resume() to start listening for guidance events.
 * {@link GuidanceNextManeuverPanelListener#onDataChanged(GuidanceNextManeuverData)}.
 */
public class GuidanceNextManeuverPanelPresenter extends BaseGuidancePresenter {

    private final Context mContext;
    private final List<GuidanceNextManeuverPanelListener> mListener = new ArrayList<>();
     ...
     */
    public GuidanceNextManeuverPanelPresenter(Context context, NavigationManager navigationManager, Route route) {
    ...
    /**
     * Adds a {@link GuidanceNextManeuverPanelListener}.
     *
     * @param listener
     *         the listener to add to the list of listeners.
     */
    public void addListener(GuidanceNextManeuverPanelListener listener) {
    ...
    /**
     * Remove a {@link GuidanceNextManeuverPanelListener}.
     *
     * @param listener
     *         the listener to remove from the list of listeners.
     */
    public void removeListener(GuidanceNextManeuverPanelListener listener) {
    ...
    private void notifyDataChanged(GuidanceNextManeuverData data) {
        for (final GuidanceNextManeuverPanelListener listener : mListener) {
