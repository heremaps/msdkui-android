...
public class TrafficOptionsPanel extends OptionsPanel implements OptionItem.OnChangedListener {
    ...
    private void createPanel() {
        mSubOptionItem = new OptionItemSpec.SingleChoiceOptionItemBuilder(getContext()).setLabels(getString(R.string.msdkui_traffic), new
                ArrayList<String>(mResourceKey.values()))
                .build();
        mSubOptionItem.setListener(this);
        setOptionsSpecs(Collections.singletonList(mSubOptionItem));
    }
