...
class AppActionBar(val activity: Activity) {
    ...
    fun setUpActionBar(): AppActionBar {
        activity.supportActionBar?.run {
            ...
            customView = activity.layoutInflater.inflate(R.layout.home_actionbar, null)
    ...
    private fun showAppInfo() {
        ...
        simpleAlert.setMessage(activity.getString(R.string.msdkui_app_versions, BuildConfig.VERSION_NAME,
                BuildConfig.VERSION_NAME, com.here.msdkui.BuildConfig.VERSION_NAME))
        simpleAlert.show()
    }
}