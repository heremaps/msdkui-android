...
public class RoutingOptionsPanel extends OptionsPanel implements OptionItem.OnChangedListener {
     ...
     */
    public RoutingOptionsPanel(final Context context) {
        this(context, null, 0);
    }
     ...
     *         a set of attributes.
     */
    public RoutingOptionsPanel(final Context context, final AttributeSet attrs) {
     ...
     */
    public RoutingOptionsPanel(final Context context, final AttributeSet attrs, final int defStyleAttr) {
    ...
    public RoutingOptionsPanel(final Context context, final AttributeSet attrs, final int defStyleAttr, final int defStyleRes) {
    ...
    private void createPanel() {
        mOptionItem = new OptionItemBuilders.MultipleChoiceOptionItemBuilder(getContext()).setLabels(getLabels())
                .build();
