...
class OptionPanelFragment : Fragment(), RoutingContracts.OptionPanel {
    ...
    private val presenter = OptionPanelPresenter()
    ...
    override fun onSubPanelClicked(panel: Panels, routeOptions: RouteOptions?) {
        listener?.openSubPanel(panel, routeOptions)
    }
