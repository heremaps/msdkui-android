...
In order to build and to run the demo app with Android Studio, you need to integrate the HERE Mobile SDK (Premium) version 3.8 or newer. Additionally, you need to integrate the HERE Mobile SDK UI Kit library.
