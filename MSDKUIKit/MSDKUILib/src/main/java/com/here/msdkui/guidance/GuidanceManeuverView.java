...
public class GuidanceManeuverView extends BaseView {
    ...
    private void init(@NonNull final Context context, @Nullable AttributeSet attributeSet) {
        ...
        if (orientation == Configuration.ORIENTATION_LANDSCAPE) {
            LayoutInflater.from(context).inflate(R.layout.guidance_maneuver_panel_screen2, this);
        } else {
            LayoutInflater.from(context).inflate(R.layout.guidance_maneuver_panel_screen1, this);
        }
