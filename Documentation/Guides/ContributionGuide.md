...
Make sure that the credentials match the package name. You may need to refactor the package name of the demo app to match the one you are registered to.

### Building and Running the Demo

In order to build and to run the demo app with Android Studio, you need to integrate the HERE Mobile SDK (Premium) version 3.8. Additionally, you need to integrate the HERE Mobile SDK UI Kit library.

- Put the HERE-sdk.aar file from your HERE SDK package and the HERE UI Kit library to _MSDKUI-Android/MSDKUIDemo/libs/_.
- Open and build the project located at _MSDKUI-Android/MSDKUIDemo/_ in Android Studio.
