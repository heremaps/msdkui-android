...
public class HazardousMaterialsOptionsPanel extends OptionsPanel implements OptionItem.OnChangedListener {
    ...
    private void createPanel() {
        mSubItems = new OptionItemSpec.MultipleChoiceOptionItemBuilder(getContext()).setLabels(new ArrayList<String>(mResourceKey.values()))
                .build();
        mSubItems.setListener(this);
        setOptionsSpecs(Collections.singletonList(mSubItems));
    }
