...
public class TruckOptionsPanel extends OptionsPanel implements OptionItem.OnChangedListener {
    ...
    private void createPanel() {
        ...
        setOptionsSpecs(mSubItem);
    }

    private OptionItem getTruckTypeOptionItem() {
        final OptionItem item = new OptionItemSpec.SingleChoiceOptionItemBuilder(getContext()).setLabels(getString(
    ...
    private OptionItem getRestrictionItem() {
        final OptionItem item = new OptionItemSpec.BooleanOptionItemBuilder(getContext()).setLabel(getString(R.string
    ...
    private OptionItem getItem(Integer id) {
        final OptionItem item = new OptionItemSpec.NumericOptionItemBuilder(getContext()).setLabel(getString(id))
                .setItemId(id).build();
        item.setListener(this);
        return item;
    }
