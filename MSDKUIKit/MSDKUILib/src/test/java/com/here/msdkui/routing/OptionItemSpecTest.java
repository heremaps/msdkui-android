 ...
 */
public final class OptionItemSpecTest extends RobolectricTest {
    ...
    public void testBooleanSpecs() {
        final OptionItem booleanOptionItem = new OptionItemSpec.BooleanOptionItemBuilder(getApplicationContext()).setLabel(mIds.get(0))
                .build();
    ...
    public void testSingleChoiceItemSpec() {
        final OptionItem singleChoiceItemSpec = new OptionItemSpec.SingleChoiceOptionItemBuilder(getApplicationContext())
    ...
    public void testMultipleChoiceItemSpec() {
        int itemId = 5;
        final OptionItem multipleChoiceItemSpec = new OptionItemSpec.MultipleChoiceOptionItemBuilder(getApplicationContext())
                .setLabels(mIds)
                .setItemId(itemId)
                .build();
    ...
    public void testNumberItemSpec() {
        final OptionItem numberItemSpec = new OptionItemSpec.NumericOptionItemBuilder(getApplicationContext())
                .setLabel(mIds.get(0))
