 ...
 * {@link ManeuverDescriptionItem#setManeuver(List, int)}.
 */
public class ManeuverDescriptionItem extends RelativeLayout {

    private final EnumMap<ManeuverDescriptionItem.Section, View> mSections = new EnumMap<>(
            ManeuverDescriptionItem.Section.class);
    private Maneuver mManeuver;

    /**
     * Constructs a new instance.
     */
    public ManeuverDescriptionItem(final Context context) {
        this(context, null);
    }
     ...
     * Constructs a new instance.
     */
    public ManeuverDescriptionItem(final Context context, final AttributeSet attrs) {
     ...
     * Constructs a new instance.
     */
    public ManeuverDescriptionItem(final Context context, final AttributeSet attrs, final int defStyleAttr) {
    ...
    private void initSections() {
        for (final ManeuverDescriptionItem.Section section : ManeuverDescriptionItem.Section.values()) {
            switch (section) {
                case ICON:
    ...
    private void attrsInit(final AttributeSet attrs, final int defStyleAttr, final int defStyleRes) {
        ...
        final TypedArray typedArray = this.getContext()
                .obtainStyledAttributes(attrs, R.styleable.ManeuverDescriptionItem, defStyleAttr, defStyleRes);
        final int section = typedArray.getInt(R.styleable.ManeuverDescriptionItem_visible, 0);
        if (section == 0) {
            return; // there is no none option
        }
    ...
    /**
     * Gets the {@link Maneuver} associated with this {@link ManeuverDescriptionItem}.
     *
    ...
    /**
     * Describes all available sections that the {@link ManeuverDescriptionItem} can show.
     */
    public enum Section {
        /**
         * Icon
